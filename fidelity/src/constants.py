...
ACCOUNT_NAME_TO_SHEET_LABEL = {
    ...
    "Individual - TOD": "Fidelity Brokerage",
    "ROTH IRA": "Fidelity Roth IRA",
    "Roth IRA": "Fidelity Roth IRA",
    "Health Savings Account": "Fidelity HSA",
    "HSA": "Fidelity HSA",
    "BROAD INSTITUTE 401K": "Fidelity Broad 401K",
    "NVIDIA 401(K) PLAN": "Fidelity 401K",
}

# Market price formula overrides for securities that are not available via their ticker
CUSTOM_MARKET_PRICE_FORMULAS_BY_DESCRIPTION = {
    "TRP RETIRE 2065 D": '=1.216*GOOGLEFINANCE("MUTF:TRSJX")',
    "VANG INST 500 IDX TR": '=0.25*GOOGLEFINANCE("VOO")',
    "VANG STRATEGIC EQ": '=GOOGLEFINANCE("MUTF:VSEQX")',
}

CUSTOM_MARKET_PRICE_FORMULAS_BY_TICKER = {
    "87281U480": CUSTOM_MARKET_PRICE_FORMULAS_BY_DESCRIPTION["TRP RETIRE 2065 D"],
    "67080C105": CUSTOM_MARKET_PRICE_FORMULAS_BY_DESCRIPTION["VANG INST 500 IDX TR"],
    "VSEQX": CUSTOM_MARKET_PRICE_FORMULAS_BY_DESCRIPTION["VANG STRATEGIC EQ"],
}
