...
Internals and invariants for anyone (human or agent) changing this tool.
[README.md](../README.md) is the user-facing surface; this is implementation detail.
...
4. **Mass-delete threshold** — deletes over 10% of owned rows require
